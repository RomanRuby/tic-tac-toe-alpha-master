...
function setStartConfiguration() {
  ...
  init.BOARD_SIZE      = +document.getElementById('board_size').value ** 2;
  newGame();
}
...
function gameOver(game) {
  ...
  if (checkForWinner(game) === 0) {
    ...
    document.getElementById('turnInfo').innerHTML = 'It is a tie.';
  } else if (checkForWinner(game) === 2) {
    document.getElementById('turnInfo').innerHTML = 'You have won! Congratulations!';
  } else {
    document.getElementById('turnInfo').innerHTML = 'The computer has won.';
  }
